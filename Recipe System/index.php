...
-->
			...
			<?php include "includes/recipe_of_day.php"; ?>
...
<?php include "includes/sidebar.php"; ?>
		...
		<div class="rw-column rw-content">
			...
			<div class="rw-row page-breadcrumb">
				<a href="#">Home</a> &raquo; <span>Recipes</span>
			</div>
...
<?php
$query=mysql_query("SELECT * FROM `dishes` order by dish_id DESC LIMIT 6 ");
do{
							...
							<div class="grid-container">
								...
								<div class="grid desk-8 omega">
									<div class="entry-title">
										<h2><a href="view_recipe.php?dish_id=<?php echo $dish_id; ?>"><?php echo $dish_name; ?></a></h2>
									</div>
