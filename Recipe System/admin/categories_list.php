					...
					<div class="row">
						...
						<table class="table table-bordered">
							<tr>
								...
								<td style="text-align:center;">Category Country Name</td>
							...
							<tr>
								...
								<td style="text-align:center;"><a href="edit_category.php?cat_id=<?php echo $cat_id; ?>"><i class="fa fa-pencil-square-o" style="color:green;" aria-hidden="true"></i></a> |
								<a href="delete_category.php?cat_id=<?php echo $cat_id; ?>"><i class="fa fa-trash-o" style="color:red;" aria-hidden="true"></i></a></td>
							</tr>
							<?php
							}} while($data);
							?>
