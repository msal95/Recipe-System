...
// Check file size
if ($_FILES["chef_photo"]["size"] > 5000000000000) {
   $uploadOk = 0;
}
...
if ($uploadOk == 0) {
  // if everything is ok, try to upload file
   ...
   $query="UPDATE `chefs` set chef_photo = '$target_file' where chef_id = '$selected' ";
						...
						<div class="row">
							...
							<form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
									<div class="form-group">
										<label class="control-label col-md-4">Chef Photo</label>
										<div class="col-md-8">
										<input type="file" name="chef_photo" class="form-control">
										<img src="<?php echo $chef_photo; ?>" width="300px" height="300px"/>
										</div>
									</div>
									<div class="form-group">
