...
// Check file size
if ($_FILES["dish_photo"]["size"] > 5000000000000) {
   $uploadOk = 0;
}
...
if ($uploadOk == 0) {
  // if everything is ok, try to upload file
   ...
   $query="UPDATE `dishes` set dish_photo = '$target_file' where dish_id = '$selected' ";
   
	header("refresh: 1; url=dishes_list.php");
		...
		<div id="page-wrapper" class="container">
			<div class="row">
				...
				<div id="content-wrapper">
					<div class="header">
					<h1 style="color:#fff;">Edit Dish Photo</h1>
					</div>
						<div class="row">
							<div class="col-lg-8">
							...
							<form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
									<div class="form-group">
										<label class="control-label col-md-4">Dish Photo</label>
										<div class="col-md-8">
										<input type="file" name="dish_photo" class="form-control">
										<img src="<?php echo $dish_photo; ?>" width="300px" height="300px"/>
										</div>
									</div>
									<div class="form-group">
