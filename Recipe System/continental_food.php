...
<?php include "includes/sidebar.php"; ?>
		...
		<div class="rw-column rw-content">
			...
			<div class="rw-row page-breadcrumb">
				<a href="#">Home</a> &raquo; <span>Continental Foods</span>
			</div>
			<div class="rw-row page-title">
				<h1>Continental Foods</h1>
			</div>
...
<?php
$query=mysql_query("SELECT * FROM `dishes` where country_name='Continental Food' order by dish_id DESC ");
do{
