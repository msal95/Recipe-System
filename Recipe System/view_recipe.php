...
?>
<p>Please<a href=""  data-toggle="modal" data-target="#mymodal"> Login Here </a> For Comment</br>
OR</br>
<a href="signup.php">Creat Account</a>
</p>
...
if(isset($_POST['submit'])){
	...
	$query=mysql_query("INSERT INTO `comments` set recipe_id='$recipe_id',  u_id='$_SESSION[u_id]', message='$message'") or die(mysql_error());
	
	if($query == 1){
		header("Location:view_recipe.php?msg=ok");

	}elseif($query == 0){
		header("Location:view_recipe.php?msg=fail");
	}
